  ...
  return knex('cashback').del()
    .then(function () {
      return knex('cashback').insert([
        ...
        { id: 3, diasemana: 'domingo', genero: 'classical', cash: '35' },
        ...
        { id: 7, diasemana: 'segunda', genero: 'classical', cash: '3' },
        ...
        { id: 11, diasemana: 'terca', genero: 'classical', cash: '5' },
        ...
        { id: 15, diasemana: 'quarta', genero: 'classical', cash: '8' },
        ...
        { id: 19, diasemana: 'quinta', genero: 'classical', cash: '13' },
        ...
        { id: 23, diasemana: 'sexta', genero: 'classical', cash: '18' },
        ...
        { id: 27, diasemana: 'sabado', genero: 'classical', cash: '25' },
